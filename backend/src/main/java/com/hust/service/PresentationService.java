...
public class PresentationService {
    ...
    public List<PresentationResponse> getRecentPresentations(Integer currentUserId) {
    ...
    public PresentationResponse getPresentationDetails(Integer projectId, Integer currentUserId) {
    ...
    @Transactional
    public PresentationResponse createPresentationFromTemplate(CreatePresentationFromTemplateRequest request, Integer currentUserId) {
        if (currentUserId == null) {
    ...
    public void processLogout(Integer currentUserId) {
