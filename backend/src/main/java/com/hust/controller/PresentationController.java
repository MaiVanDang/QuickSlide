...
public class PresentationController {
    ...
    public ResponseEntity<List<PresentationResponse>> getRecentProjects() {
        ...
        Long currentUserId = SecurityUtil.getCurrentUserId(); // Lấy ID User từ Security Context
    ...
    @GetMapping("/{id}")
    public ResponseEntity<PresentationResponse> getProjectDetails(@PathVariable Long id) {
