...
const helpTopics: Record<HelpCategory, { id: number; title: string; preview: string }[]> = {
  ...
  'guide': [
    { 
      id: 10, 
      title: 'クイック作成とバッチ生成の使い方はどうすればいいですか。', 
    ...
    { id: 11, title: 'バッチ生成はExcelのインポートしかできないんですか。', preview: 'いいえ、Googleドキュメントのリンクを送信することも可能です。Excelの場合、A列にプレゼン資料のタイトル、B列に内容を入力する形になりますが、入力作業が大変な場合は、ドキュメントに内容を書き込んで、そのリンクを貼り付けて使用することもできます。' },
  ],
};
